...
public class WorldGenSakuraTree extends WorldGenAbstractTree {
    ...
    private static final IBlockState LOG = SSBlocks.sakuraLog.getDefaultState();
    private static final IBlockState LEAF = SSBlocks.sakuraLeaves.getDefaultState().withProperty(BlockSSLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public WorldGenSakuraTree(boolean p_i2027_1_) {
        this(p_i2027_1_, 4, LOG, LEAF, false);
    }

    public WorldGenSakuraTree(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_, boolean p_i46446_5_) {
        super(p_i46446_1_);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight()) {
            ...
            if (!flag) {
                ...
                if (state.getBlock().canSustainPlant(state, worldIn, position.down(), net.minecraft.util.EnumFacing.UP, (net.minecraft.block.BlockSapling) Blocks.SAPLING)
