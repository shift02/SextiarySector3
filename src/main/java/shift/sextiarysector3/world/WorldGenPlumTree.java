...
public class WorldGenPlumTree extends WorldGenAbstractTree {
    ...
    private static final IBlockState TRUNK = SSBlocks.plumLog.getDefaultState();//.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA);
    private static final IBlockState LEAF = SSBlocks.plumLeaves.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenPlumTree(boolean doBlockNotify) {
        super(doBlockNotify);
    }
